...
# Only for 10x1 decomposition for domains [[-4, 4]] * 10 and [[-10, 10]] * 10
c2_P = lyznet.verify_network_quadratic_reach(
            subsystems, interconnections, c1_P, c_P
            )
